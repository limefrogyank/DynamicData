...
var VERSION = "3.0.0-preview4-19216-03";
...
/* harmony import */ var _JsonHubProtocol__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(25);
/* harmony import */ var _Loggers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
...
var HubConnectionBuilder = /** @class */ (function () {
    ...
    HubConnectionBuilder.prototype.configureLogging = function (logging) {
        _Utils__WEBPACK_IMPORTED_MODULE_5__["Arg"].isRequired(logging, "logging");
        if (isLogger(logging)) {
            this.logger = logging;
        }
        else {
            this.logger = new _Utils__WEBPACK_IMPORTED_MODULE_5__["ConsoleLogger"](logging);
        }
        return this;
    };
    ...
    HubConnectionBuilder.prototype.build = function () {
        ...
        return _HubConnection__WEBPACK_IMPORTED_MODULE_2__["HubConnection"].create(connection, this.logger || _Loggers__WEBPACK_IMPORTED_MODULE_4__["NullLogger"].instance, this.protocol || new _JsonHubProtocol__WEBPACK_IMPORTED_MODULE_3__["JsonHubProtocol"](), this.reconnectPolicy);
    };
